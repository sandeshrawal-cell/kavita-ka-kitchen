...
for(const name of ['app.js','core.js','storage.js','catalog.js','auth-client.js','features.js','intelligence.js','photos.js','i18n.js','styles.css'])await fs.copyFile('src/'+name,'dist/assets/'+name);
